...
class Transaction(AuditoriaMixin, Base):
    ...
    # A MAGIA QUE RESOLVE O CONFLITO DE MEMÓRIA DO FASTAPI
    ...
    valor_taxas = Column(Numeric(10, 2), default=0)
